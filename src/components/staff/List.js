...
import { list, reset } from '../../actions/staff/list';
import { success } from '../../actions/staff/delete';
...
const mapStateToProps = state => {
  const {retrieved, error, loading, eventSource} = state.staff.list;
