        ...
        <ListItem
            ...
            subtitle={
              <View>
                ...
                <View style={viewList}>
                  <Text style={listRowLeft}>startDate: </Text>
                  <Text style={[listRowRight, {fontWeight: 'bold'}]}>{item['startDate']}</Text>
                </View>
                <View style={viewList}>
                  <Text style={listRowLeft}>endDate: </Text>
                  <Text style={[listRowRight, {fontWeight: 'bold'}]}>{item['endDate']}</Text>
                </View>
                <View style={viewList}>
...
const mapStateToProps = state => {
  const {retrieved, error, loading, eventSource} = state.task.list;
