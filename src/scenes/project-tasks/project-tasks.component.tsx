...
export const ProjectTasksScreen = ({ navigation }): React.ReactElement => {
  ...
  const renderHeader = (): React.ReactElement => (
    <React.Fragment>
      <Text
        ...
        category='s2'>
        Voici la liste de toutes les tâches confondues pour ce projet, qu'elles soient en cours, terminées ou à faire.
      </Text>
