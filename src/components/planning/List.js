...
import { list, reset } from '../../actions/planning/list';
import { success } from '../../actions/planning/delete';
        ...
        <ListItem
            ...
            subtitle={
              <View>
                ...
                <View style={viewList}>
                  <Text style={listRowLeft}>startAt: </Text>
                  <Text style={[listRowRight, {fontWeight: 'bold'}]}>{item['startAt']}</Text>
                </View>
                <View style={viewList}>
                  <Text style={listRowLeft}>endAt: </Text>
                  <Text style={[listRowRight, {fontWeight: 'bold'}]}>{item['endAt']}</Text>
                </View>
                <View style={viewList}>
                  <Text style={listRowLeft}>color: </Text>
                  <Text style={[listRowRight, {fontWeight: 'bold'}]}>{item['color']}</Text>
                </View>
              </View>
            }
        />
...
const mapStateToProps = state => {
  const {retrieved, error, loading, eventSource} = state.planning.list;
