...
import { create, loading, error, reset } from '../../actions/associationprofile/create';
...
class Create extends Component {
  ...
  onSubmit = values => {
    ...
    Actions.associationprofileList();
    delayRefresh();
  };
...
const mapStateToProps = state => {
  const {created, error, loading} = state.associationprofile.create;
