...
import { success } from '../../actions/projectplanning/create';
import { retrieve, update, reset } from '../../actions/projectplanning/update';
import { loading, error } from '../../actions/projectplanning/delete';
...
const mapStateToProps = state => ({
  retrieveError: state.projectplanning.update.retrieveError,
  retrieveLoading: state.projectplanning.update.retrieveLoading,
  updateError: state.projectplanning.update.updateError,
  updateLoading: state.projectplanning.update.updateLoading,
  created: state.projectplanning.create.created,
  deleted: state.projectplanning.del.deleted,
  retrieved: state.projectplanning.update.retrieved,
  updated: state.projectplanning.update.updated,
});
