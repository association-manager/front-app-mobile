...
import { list, reset } from '../../actions/projectplanning/list';
import { success } from '../../actions/projectplanning/delete';
...
class ListComponent extends Component {
  ...
  static show(id) {
    Actions.projectplanningShow({id});
  }
...
const mapStateToProps = state => {
  const {retrieved, error, loading, eventSource} = state.projectplanning.list;
