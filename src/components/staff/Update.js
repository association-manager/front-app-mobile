...
import { success } from '../../actions/staff/create';
import { retrieve, update, reset } from '../../actions/staff/update';
import { loading, error } from '../../actions/staff/delete';
...
const mapStateToProps = state => ({
  retrieveError: state.staff.update.retrieveError,
  retrieveLoading: state.staff.update.retrieveLoading,
  updateError: state.staff.update.updateError,
  updateLoading: state.staff.update.updateLoading,
  created: state.staff.create.created,
  deleted: state.staff.del.deleted,
  retrieved: state.staff.update.retrieved,
  updated: state.staff.update.updated,
});
