...
import { success } from '../../actions/member/delete';
        ...
        <ListItem
            ...
            subtitle={
              <View>
                ...
                <View style={viewList}>
                  <Text style={listRowLeft}>profile: </Text>
                  <Text style={[listRowRight, {fontWeight: 'bold'}]}>{item['profile']}</Text>
                </View>
                <View style={viewList}>
...
const mapStateToProps = state => {
  const {retrieved, error, loading, eventSource} = state.member.list;
