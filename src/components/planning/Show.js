...
import { retrieve, reset } from '../../actions/planning/show';
import { del, loading, error } from '../../actions/planning/delete';
import { list } from '../../actions/planning/list';
    ...
    return (
        <View style={styles.actionStyle}>
          <SocialIcon
              ...
              type='plus-circle'
              iconColor='#3faab4'
              onPress={() => Actions.planningCreate()}
          />
          <SocialIcon
              iconSize={34}
              type='edit'
              iconColor='#3faab4'
              onPress={() => Actions.planningUpdate({id})}
          />
          <SocialIcon
              iconSize={34}
              type='minus-circle'
          ...
          <ScrollView>
            ...
            <Card title="Planning">
              <List title="title">
                ...
                {Show.renderRow('color', item['color'])}
              </List>
            </Card>
            }
...
const mapStateToProps = (state) => {
  return {
    error: state.planning.show.error,
    loading: state.planning.show.loading,
    retrieved: state.planning.show.retrieved,
    deleteError: state.planning.del.error,
    deleteLoading: state.planning.del.loading,
    deleted: state.planning.del.deleted,
  };
};
