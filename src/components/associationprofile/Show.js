...
import { retrieve, reset } from '../../actions/associationprofile/show';
import { del, loading, error } from '../../actions/associationprofile/delete';
import { list } from '../../actions/associationprofile/list';
    ...
    return (
        <View style={styles.actionStyle}>
          <SocialIcon
              ...
              type='plus-circle'
              iconColor='#3faab4'
              onPress={() => Actions.associationprofileCreate()}
          />
          <SocialIcon
              iconSize={34}
              type='edit'
              iconColor='#3faab4'
              onPress={() => Actions.associationprofileUpdate({id})}
          />
          <SocialIcon
              iconSize={34}
              type='minus-circle'
...
const mapStateToProps = (state) => {
  return {
    error: state.associationprofile.show.error,
    loading: state.associationprofile.show.loading,
    retrieved: state.associationprofile.show.retrieved,
    deleteError: state.associationprofile.del.error,
    deleteLoading: state.associationprofile.del.loading,
    deleted: state.associationprofile.del.deleted,
  };
};
