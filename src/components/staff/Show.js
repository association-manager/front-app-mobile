...
import { retrieve, reset } from '../../actions/staff/show';
import { del, loading, error } from '../../actions/staff/delete';
import { list } from '../../actions/staff/list';
    ...
    return (
        <View style={styles.actionStyle}>
          <SocialIcon
              ...
              type='plus-circle'
              iconColor='#3faab4'
              onPress={() => Actions.staffCreate()}
          />
          <SocialIcon
              iconSize={34}
              type='edit'
              iconColor='#3faab4'
              onPress={() => Actions.staffUpdate({id})}
          />
          <SocialIcon
              iconSize={34}
              type='minus-circle'
...
const mapStateToProps = (state) => {
  return {
    error: state.staff.show.error,
    loading: state.staff.show.loading,
    retrieved: state.staff.show.retrieved,
    deleteError: state.staff.del.error,
    deleteLoading: state.staff.del.loading,
