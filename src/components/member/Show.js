...
import { retrieve, reset } from '../../actions/member/show';
import { del, loading, error } from '../../actions/member/delete';
import { list } from '../../actions/member/list';
    ...
    return (
        <View style={styles.actionStyle}>
          ...
          <SocialIcon
              ...
              type='edit'
              iconColor='#3faab4'
              onPress={() => Actions.memberUpdate({id})}
          />
          <SocialIcon
              iconSize={34}
              type='minus-circle'
          ...
          <ScrollView>
            ...
            <Card title="Member">
              <List title="title">
                ...
                {Show.renderRow('profile', item['profile'])}
...
const mapStateToProps = (state) => {
  return {
    error: state.member.show.error,
    loading: state.member.show.loading,
    retrieved: state.member.show.retrieved,
    deleteError: state.member.del.error,
    deleteLoading: state.member.del.loading,
