...
import { list, reset } from '../../actions/association/list';
import { success } from '../../actions/association/delete';
        ...
        <ListItem
            ...
            subtitle={
              <View>
                ...
                <View style={viewList}>
                  <Text style={listRowLeft}>dataUsageAgreement: </Text>
                  <Text style={[listRowRight, {fontWeight: 'bold'}]}>{item['dataUsageAgreement']}</Text>
                </View>
                <View style={viewList}>
                  <Text style={listRowLeft}>associationType: </Text>
                  <Text style={[listRowRight, {fontWeight: 'bold'}]}>{item['associationType']}</Text>
                </View>
                <View style={viewList}>
                  <Text style={listRowLeft}>phoneNumber: </Text>
                  <Text style={[listRowRight, {fontWeight: 'bold'}]}>{item['phoneNumber']}</Text>
                </View>
                <View style={viewList}>
                  <Text style={listRowLeft}>mobile: </Text>
                  <Text style={[listRowRight, {fontWeight: 'bold'}]}>{item['mobile']}</Text>
                </View>
                <View style={viewList}>
                ...
                <View style={viewList}>
                  <Text style={listRowLeft}>firstName: </Text>
                  <Text style={[listRowRight, {fontWeight: 'bold'}]}>{item['firstName']}</Text>
                </View>
                <View style={viewList}>
                  <Text style={listRowLeft}>lastName: </Text>
                  <Text style={[listRowRight, {fontWeight: 'bold'}]}>{item['lastName']}</Text>
                </View>
                <View style={viewList}>
                  <Text style={listRowLeft}>assemblyConstituveDate: </Text>
                  <Text style={[listRowRight, {fontWeight: 'bold'}]}>{item['assemblyConstituveDate']}</Text>
                </View>
                <View style={viewList}>
                  <Text style={listRowLeft}>foundedAt: </Text>
                  <Text style={[listRowRight, {fontWeight: 'bold'}]}>{item['foundedAt']}</Text>
                </View>
                <View style={viewList}>
...
const mapStateToProps = state => {
  const {retrieved, error, loading, eventSource} = state.association.list;
