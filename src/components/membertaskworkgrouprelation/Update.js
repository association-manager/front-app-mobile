...
import { success } from '../../actions/membertaskworkgrouprelation/create';
import { retrieve, update, reset } from '../../actions/membertaskworkgrouprelation/update';
import { loading, error } from '../../actions/membertaskworkgrouprelation/delete';
...
const mapStateToProps = state => ({
  retrieveError: state.membertaskworkgrouprelation.update.retrieveError,
  retrieveLoading: state.membertaskworkgrouprelation.update.retrieveLoading,
  updateError: state.membertaskworkgrouprelation.update.updateError,
  updateLoading: state.membertaskworkgrouprelation.update.updateLoading,
  created: state.membertaskworkgrouprelation.create.created,
  deleted: state.membertaskworkgrouprelation.del.deleted,
  retrieved: state.membertaskworkgrouprelation.update.retrieved,
  updated: state.membertaskworkgrouprelation.update.updated,
});
