    ...
    return (
        <View style={styles.actionStyle}>
          <SocialIcon
              ...
              type='plus-circle'
              iconColor='#3faab4'
              onPress={() => Actions.taskCreate()}
          />
          <SocialIcon
              iconSize={34}
              type='edit'
              iconColor='#3faab4'
              onPress={() => Actions.taskUpdate({id})}
          />
          <SocialIcon
              iconSize={34}
              type='minus-circle'
          ...
          <ScrollView>
            ...
            <Card title="Task">
              <List title="title">
                ...
                {Show.renderRow('startDate', item['startDate'])}
                {Show.renderRow('endDate', item['endDate'])}
                {Show.renderRow('type', item['type'])}
