    ...
    return (
      <View>
        ...
        <FormInput containerStyle={ {flexDirection:'row'} }
                   ...
                   id={`projectplanning_${data.input.name}`}
                   multiline={true}
    ...
    return (
      <View style={ {backgroundColor: 'white', paddingBottom: 20} }>
        ...
        <Field component={this.renderField} name="endAt" type="dateTime"
          placeholder="" />
        <Field component={this.renderField} name="project" type="text"
          placeholder="" />
        <Field component={this.renderField} name="tasks" type="text"
          placeholder="" />
