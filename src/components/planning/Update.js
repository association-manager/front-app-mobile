...
import { success } from '../../actions/planning/create';
import { retrieve, update, reset } from '../../actions/planning/update';
import { loading, error } from '../../actions/planning/delete';
...
const mapStateToProps = state => ({
  retrieveError: state.planning.update.retrieveError,
  retrieveLoading: state.planning.update.retrieveLoading,
  updateError: state.planning.update.updateError,
  updateLoading: state.planning.update.updateLoading,
  created: state.planning.create.created,
  deleted: state.planning.del.deleted,
  retrieved: state.planning.update.retrieved,
  updated: state.planning.update.updated,
});
