...
import { success } from '../../actions/project/delete';
        ...
        <ListItem
            ...
            subtitle={
              <View>
                ...
                <View style={viewList}>
                  <Text style={listRowLeft}>projectType: </Text>
                  <Text style={[listRowRight, {fontWeight: 'bold'}]}>{item['projectType']}</Text>
                </View>
                <View style={viewList}>
...
const mapStateToProps = state => {
  const {retrieved, error, loading, eventSource} = state.project.list;
