...
import { success } from '../../actions/associationprofile/create';
import { retrieve, update, reset } from '../../actions/associationprofile/update';
import { loading, error } from '../../actions/associationprofile/delete';
...
const mapStateToProps = state => ({
  retrieveError: state.associationprofile.update.retrieveError,
  retrieveLoading: state.associationprofile.update.retrieveLoading,
  updateError: state.associationprofile.update.updateError,
  updateLoading: state.associationprofile.update.updateLoading,
  created: state.associationprofile.create.created,
  deleted: state.associationprofile.del.deleted,
  retrieved: state.associationprofile.update.retrieved,
  updated: state.associationprofile.update.updated,
});
