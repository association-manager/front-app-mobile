...
import { success } from '../../actions/association/create';
import { retrieve, update, reset } from '../../actions/association/update';
import { loading, error } from '../../actions/association/delete';
...
const mapStateToProps = state => ({
  retrieveError: state.association.update.retrieveError,
  retrieveLoading: state.association.update.retrieveLoading,
  updateError: state.association.update.updateError,
  updateLoading: state.association.update.updateLoading,
  created: state.association.create.created,
  deleted: state.association.del.deleted,
  retrieved: state.association.update.retrieved,
  updated: state.association.update.updated,
});
