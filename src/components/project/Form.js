    ...
    return (
      <View style={ {backgroundColor: 'white', paddingBottom: 20} }>
        ...
        <Field component={this.renderField} name="endAt" type="dateTime"
          placeholder="" required={true} />
        <Field component={this.renderField} name="status" type="checkbox"
          placeholder="" />
        <Field component={this.renderField} name="projectType" type="text"
          placeholder="" />
        <Field component={this.renderField} name="description" type="text"
          placeholder="" />
        <Field component={this.renderField} name="planning" type="text"
          placeholder="" />
        <Field component={this.renderField} name="projectPlannings" type="text"
          placeholder="" />
