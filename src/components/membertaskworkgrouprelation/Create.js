...
import { create, loading, error, reset } from '../../actions/membertaskworkgrouprelation/create';
...
class Create extends Component {
  ...
  onSubmit = values => {
    ...
    Actions.membertaskworkgrouprelationList();
    delayRefresh();
  };
...
const mapStateToProps = state => {
  const {created, error, loading} = state.membertaskworkgrouprelation.create;
