...
import { list, reset } from '../../actions/associationprofile/list';
import { success } from '../../actions/associationprofile/delete';
...
class ListComponent extends Component {
  ...
  static show(id) {
    Actions.associationprofileShow({id});
  }
        ...
        <ListItem
            ...
            subtitle={
              <View>
                ...
                <View style={viewList}>
                  <Text style={listRowLeft}>descriptionTitle: </Text>
                  <Text style={[listRowRight, {fontWeight: 'bold'}]}>{item['descriptionTitle']}</Text>
                </View>
              </View>
            }
        />
...
const mapStateToProps = state => {
  const {retrieved, error, loading, eventSource} = state.associationprofile.list;
