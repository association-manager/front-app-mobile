...
import ContentView from '../../layouts/project';

export const ProjectListByAssociationScreen = ({ navigation }): React.ReactElement => {
  ...
  return (
    <SafeAreaLayout
      ...
      insets='top'>
      <TopNavigation
        title='Tous les projets de cette association'
