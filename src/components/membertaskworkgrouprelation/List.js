...
import { list, reset } from '../../actions/membertaskworkgrouprelation/list';
import { success } from '../../actions/membertaskworkgrouprelation/delete';
...
class ListComponent extends Component {
  ...
  static show(id) {
    Actions.membertaskworkgrouprelationShow({id});
  }
...
const mapStateToProps = state => {
  const {retrieved, error, loading, eventSource} = state.membertaskworkgrouprelation.list;
