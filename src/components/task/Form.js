    ...
    return (
      <View style={ {backgroundColor: 'white', paddingBottom: 20} }>
        <Field component={this.renderField} name="title" type="text"
          placeholder="" />
        <Field component={this.renderField} name="startDate" type="dateTime"
          placeholder="" />
        <Field component={this.renderField} name="endDate" type="dateTime"
          placeholder="" />
        <Field component={this.renderField} name="type" type="text"
          placeholder="" />
        <Field component={this.renderField} name="description" type="text"
          placeholder="" />
        <Field component={this.renderField} name="projectPlanning" type="text"
          placeholder="" />
