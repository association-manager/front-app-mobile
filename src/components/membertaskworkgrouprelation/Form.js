    ...
    return (
      <View>
        ...
        <FormInput containerStyle={ {flexDirection:'row'} }
                   ...
                   id={`membertaskworkgrouprelation_${data.input.name}`}
                   multiline={true}
  ...
  render() {
    ...
    return (
      <View style={ {backgroundColor: 'white', paddingBottom: 20} }>
        <Field component={this.renderField} name="member" type="text"
          placeholder="" />
        <Field component={this.renderField} name="task" type="text"
          placeholder="" />
        <Field component={this.renderField} name="workGroup" type="text"
          placeholder="" />
...
export default reduxForm(
    {
      form: 'membertaskworkgrouprelation',
